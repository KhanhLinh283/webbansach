...
<head>
    <title>BookStore - Sách mới tuyển chọn</title>
                ...
                <div class="modal-body">
                    <form id="form-signup" class="form-signin mt-2">
                        ...
                        <div class="custom-control custom-checkbox">
                            <p class="text-center">Bằng việc đăng ký, bạn đã đồng ý với BookStore về</p>
                ...
                <div class="col-md-5 ml-auto contact d-none d-md-block">
                    <div class="benphai float-right">
                        <div class="hotline">
                            ...
                            <span>Hotline:<b>1234 5678</b> </span>
                        </div>
                ...
                <div class="items">
                    ...
                    <!-- 1 sản phẩm  -->
                        <div class="col-lg-3 col-md-4 col-xs-6">
                            <div class="card">
                                <a href="sach-moi-tuyen-chon.php" class="motsanpham"
